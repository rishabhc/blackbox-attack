...
class cifar10_models_simple(object):
	...
	def load_weights(self):
		...
		checkpoint = tf.train.latest_checkpoint('CIFAR10_models/Normal_simple_models/simple/')
	...
	def save_everything(self):
		self.tf_checkpoint_path = tf.train.Saver(self.var_list).save(self.sess, 'CIFAR10_models/Normal_simple_models/simple')
		print(self.tf_checkpoint_path)
